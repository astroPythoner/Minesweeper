...
namespace Minesweeper
{
    partial class Oberflaeche
    {
        ...
        private void InitializeStartComponent()
        {
            ...
            this.titel_label.Text = "Minesweeper";
            ...
            this.info_label.Name = "Info";
            this.info_label.TabStop = false;
            this.info_label.Text = "Informatik GFS Fabian Langer";
            ...
            this.start_button.Text = "Spiel starten";
        ...
        private void InitializeComponent(int x_size, int y_size, int button_size)
        {
            ...
            this.slove_bombs_button.Name = "solve_bombs_button";
            this.slove_bombs_button.Text = "Alle Felder, die Bomben sind";
            ...
            this.solve_free_button.Name = "solve_free_button";
            this.solve_free_button.Text = "Alle Felder, die frei sein müssen";
            ...
            this.solve_solvable_button.Name = "solve_solvable_button";
            this.solve_solvable_button.Text = "Alle Felder, die lösbar sind";
